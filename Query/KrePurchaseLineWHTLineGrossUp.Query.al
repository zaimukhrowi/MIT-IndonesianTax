query 60011 KrePurchaseLineWHTLineGrossUp
{
    QueryType = Normal;
    ...
    elements
    {
        dataitem(Purchase_Line; "Purchase Line")
        {
            ...
            dataitem(Kre_MasterPPh; Kre_MasterPPh)
            {
                ...
                column(Purch__WHT_Account__Gross_Up_; "Purch. WHT Account (Gross Up)")
                { }
                dataitem(G_L_Account; "G/L Account")
                {
                    DataItemLink = "No." = Kre_MasterPPh."Purch. WHT Account (Gross Up)";
